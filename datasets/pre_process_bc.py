...
from bpe_4w_pcl.tokenization_jieba import JIEBATokenizer
import jieba
...
parser.add_argument('--output_file', type=str,
                    default='/cache/MindRecord/mPanGu_zh-en_mindrecord',
                    help="Save mindrecord path.")
parser.add_argument('--num_process', type=int, default=20,
                    help="Save checkpoint path.")
parser.add_argument('--tokenizer', type=str, default='spm_13w',
                    help="Save checkpoint path.")
...
if __name__ == '__main__':
    ...
    if args.dataset_type == 'openwebtext':
        ...
        print(time_use)
        print("Time consuming: {} h.{} m.{} s".format(int((time_use/3600)), (int(time_use/60))%60, time_use%60), flush=True)
