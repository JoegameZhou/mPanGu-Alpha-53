...
from src.utils_m53_exp4_54000 import get_args
...
def run_predict_langs21(model_predict, config, args_opt):
    ...
    langs_zh = [['vi', 'ko', 'en', 'nl'], 
                ...
                ['ur', 'bn', 'ne']]# 0-12
    """
    langs_zh = [['tr'], ['kk'], ['uz'], ['az'], ['hi'], ['ta'], ['ur'], ['bn'], ['ne']]
    ...
    for langs in langs_5:
        try:
            ...
            obs_save_dir = f"obs://research-my2/taoht-13b/multi_langs_translate/mPanGu_langs53/{obs_sub_dir}/flores_zh-langs-exp4-54000_remove_deplicate/"
