...
def add_retrain_params(opt):
    ...
    opt.add_argument("--save_checkpoint_bucket_dir",
                     type=str,
                     default="s3://research-my2/taoht-13b/ckpt/mPanGu_53-26b-128k-m1d128-22m1d24/mPanGu_53-26b-128k-m1d128-22m3d12-exp2",
                     help="Save checkpoint path.")
    opt.add_argument("--save_strategy_bucket_dir",
                     type=str,
                     default="s3://research-my2/taoht-13b/strategy_ckpt/mPanGu_53-26b-128k-m1d128-22m3d12-exp2-strategy.ckpt",
                     help="Save checkpoint path.")
    opt.add_argument("--strategy_load_ckpt_path",##obs://mindspore-file/strategy_ckpt/gpt_1024_13b_exp66cktp_strategy_512.ckpt
                        type=str,## Multi-langs21-pangu26-400_182G-pretrain-d128-128k-m1d128-bz4-21m11d27-exp01strategy.ckpt
                        default="obs://research-my2/taoht-13b/strategy_ckpt/mPanGu_53-26b-128k-m1d128-22m1d24-exp0-strategy.ckptstrategy.ckpt",
                        help="The training prallel strategy for the model.")##Multi-langs21-pangu26-d64-128k-m1d64-bz4-21m12d7-exp02strategy.ckpt
...
#     f's3://research-my2/taoht-13b/filtered_ckpt/language_enzh/{filter_ckpt}/{filter_ckpt}'
    parser.add_argument("--load_ckpt_obs_path",
                        ...
                        default='s3://research-my2/taoht-13b/filtered_ckpt/mPanGu_53-26b-128k-m1d128-22m1d24/mPanGu_53-26b-128k-m1d128-22m3d26-exp4/exp4-54000/',
    ...
    parser.add_argument("--language",
                        type=str,
                        default="en",
                        choices=["en", "ar", "bg", "bn", "de", "es", "fa", "fr", "he", "hi", "ko", "pt", "ru", "sr", "ta", "uk", "ur", "vi", "pl", "cs", "km", "ps", "es", "ro", "tr", "lv", "et"],
                        help="The language to translation")# wmt-10:hi, fr, lv, ro, cs, de, tr, et
