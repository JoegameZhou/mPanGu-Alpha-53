...
def load_distributed_checkpoint(network, checkpoint_filenames, predict_strategy=None,
    ...
    for _, param in network.parameters_and_names():
        ...
        if train_strategy[param.name][5]:
            ##----taoht------
            shard_size = 64 #ckpt_file_len // shard_stride // train_strategy[param.name][5]
        ...
        for rank in param_rank:
            ...
            if shard_stride > 0:
                ...
                param_index.sort()
                # print("000000000000000000"*10)
                # print("param.name: ", param.name)
                # print("shard_size: ", shard_size)
                # print("shard_stride", shard_stride)
            ...
            # print('sliced_param', sliced_param)
