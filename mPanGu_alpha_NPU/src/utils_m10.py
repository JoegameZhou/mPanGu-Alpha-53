...
def add_retrain_params(opt):
    ...
    opt.add_argument("--save_checkpoint_bucket_dir",
                     type=str,
                     default="s3://research-my/taoht-13b/ckpt/mPanGu_10-350M-128k-d64-22m4d28/exp0",
                     help="Save checkpoint path.")
    opt.add_argument("--save_strategy_bucket_dir",
                     type=str,
                     default="s3://research-my/taoht-13b/strategy_ckpt/mPanGu_10-350M-128k-d64-22m4d28-exp0-strategy.ckpt",
                     help="Save checkpoint path.")
    opt.add_argument("--strategy_load_ckpt_path",
                        type=str,
                        default="obs://research-my/taoht-13b/strategy_ckpt/mPanGu_53-26b-128k-m1d128-22m1d24-exp0-strategy.ckptstrategy.ckpt",
...
def get_args(inference=False):
    ...
    parser.add_argument('--data_url',
                        required=False,
                        default='obs://research-my/datasets/V0-350M-10_Pretrain/',
    ...
    parser.add_argument("--mode",
                        type=str,
                        default="2.6B",
                        choices=["200B", "13B", "2.6B", "350M", "self_define"],
    ...
    parser.add_argument("--load_ckpt_obs_path",
                        type=str,
                        default='s3://research-my/taoht-13b/ckpt/mPanGu_53-26b-128k-m1d128-22m1d24-exp0/',
                        help="predict file path.")## 
    parser.add_argument("--load_obs_ckptname",
                        type=str,
                        default='mPanGu53-26b-stage0_0-457500_2',
