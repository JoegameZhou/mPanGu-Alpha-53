...
def run_train(args_opt):
    ...
    update_cell = DynamicLossScaleUpdateCell(loss_scale_value=math.pow(2, 16), scale_factor=2, scale_window=1500)
    ...
    #for key, value in pangu_alpha.parameters_dict().items():
    #    if 'adam'not in key:
